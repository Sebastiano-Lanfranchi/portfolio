...
function Header() {
    ...
    return (
        <nav className="flex justify-between w-3/4 center-div border-b-4 header__borderRadius pt-4 fade-in-left">
            <div className='w-1/3 flex-none header__textPositionTitle text titleFont text-6xl pt-3 font-bold text-white cursor-pointer' onClick={() => store.onOfHomepage('hom')}>Sebastiano Lanfranchi</div>
